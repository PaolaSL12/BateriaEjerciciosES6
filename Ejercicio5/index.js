...
const selectionOfStremears = streamers.filter((streamer) => {
    if (streamer.gameMorePlayed === 'League of Legends' ) {
        return streamer
    }
})

console.log(selectionOfStremears);
...
const streamerWithU = streamers2.filter ((streamer) => {
...
const filterStreamers = streamers2.filter((streamer) => {
